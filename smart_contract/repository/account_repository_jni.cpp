  ...
  (JNIEnv *env, jclass cls, jstring uuid_)
{
    ...
    object::Account account = repository::account::findByUuid(hash::sha3_256_hex(senderPublicKey));

    std::unordered_map<std::string, std::string> params;
    params["publicKey"] = object::Account::publicKey;
    params["name"]      = object::Account::name;
    // TODO: params["assets"]
